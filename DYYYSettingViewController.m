...
- (void)setupSettingItems {
    self.settingSections = @[
        @[
            ...
            [DYYYSettingItem itemWithTitle:@"全局文字颜色" key:@"DYYYGlobalTextColor" type:DYYYSettingItemTypePicker],
            ...
            [DYYYSettingItem itemWithTitle:@"全局文字颜色" key:@"DYYYGlobalTextColor" type:DYYYSettingItemTypeTextField placeholder:@"十六进制"],
            [DYYYSettingItem itemWithTitle:@"启用渐变色文字" key:@"DYYYEnableGradientText" type:DYYYSettingItemTypeSwitch],
            [DYYYSettingItem itemWithTitle:@"渐变文字颜色1" key:@"DYYYGradientTextColor1" type:DYYYSettingItemTypeTextField placeholder:@"十六进制"],
            [DYYYSettingItem itemWithTitle:@"渐变文字颜色2" key:@"DYYYGradientTextColor2" type:DYYYSettingItemTypeTextField placeholder:@"十六进制"],
            [DYYYSettingItem itemWithTitle:@"渐变文字颜色3" key:@"DYYYGradientTextColor3" type:DYYYSettingItemTypeTextField placeholder:@"十六进制"],
            [DYYYSettingItem itemWithTitle:@"渐变文字颜色4" key:@"DYYYGradientTextColor4" type:DYYYSettingItemTypeTextField placeholder:@"十六进制"],
            [DYYYSettingItem itemWithTitle:@"渐变文字颜色5" key:@"DYYYGradientTextColor5" type:DYYYSettingItemTypeTextField placeholder:@"十六进制"],
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (item.type == DYYYSettingItemTypePicker) {
        ...
        if ([item.key isEqualToString:@"DYYYGlobalTextColor"]) {
            [self showColorPickerForIndexPath:indexPath];
            return;
        }
...
- (void)showColorPickerForIndexPath:(NSIndexPath *)indexPath {
    ...
    colorPicker.colorSelectedHandler = ^(NSString *colorScheme) {
        ...
        if (cell) {
            cell.detailTextLabel.text = [self colorSchemeDisplayName:colorScheme];
        }
        
        // 发送通知，让 DYYY.xm 重新加载颜色
...
- (NSString *)colorSchemeDisplayName:(NSString *)colorScheme {
    if ([colorScheme isEqualToString:@"#FFFFFF"]) return @"纯白色";
